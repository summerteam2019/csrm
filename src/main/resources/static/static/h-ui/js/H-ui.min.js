...
(function (a) {
    ...
    f.fn.ajaxForm = function (g) {
        ...
        return this.ajaxFormUnbind().on("submit.form-plugin", g, b).on("click.form-plugin", g, a)
    };
...
(function (a, d, b) {
    var c = function (e, g) {
        var f = !!d.getComputedStyle;
        if (!f) {
            d.getComputedStyle = function (x) {
                this.el = x;
                this.getPropertyValue = function (z) {
                    var y = /(\-([a-z]){1})/g;
                    if (z === "float") {
                        z = "styleFloat"
                    }
                    if (y.test(z)) {
                        z = z.replace(y, function () {
                            return arguments[2].toUpperCase()
                        })
                    }
                    return x.currentStyle[z] ? x.currentStyle[z] : null
                };
                return this
            }
        }
        var q = function (A, y, z, x) {
            if ("addEventListener" in A) {
                try {
                    A.addEventListener(y, z, x)
                } catch (B) {
                    if (typeof z === "object" && z.handleEvent) {
                        A.addEventListener(y, function (C) {
                            z.handleEvent.call(z, C)
                        }, x)
                    } else {
                        throw B
                    }
                ...
                if ("attachEvent" in A) {
                    if (typeof z === "object" && z.handleEvent) {
                        A.attachEvent("on" + y, function () {
                            z.handleEvent.call(z)
                        })
                    } else {
                        A.attachEvent("on" + y, z)
                    }
                }
            }
        }, r = function (A, y, z, x) {
            if ("removeEventListener" in A) {
                try {
                    A.removeEventListener(y, z, x)
                } catch (B) {
                    if (typeof z === "object" && z.handleEvent) {
                        A.removeEventListener(y, function (C) {
                            z.handleEvent.call(z, C)
                        }, x)
                    } else {
                        throw B
                ...
                if ("detachEvent" in A) {
                    if (typeof z === "object" && z.handleEvent) {
                        A.detachEvent("on" + y, function () {
                            z.handleEvent.call(z)
                        })
                    } else {
                        A.detachEvent("on" + y, z)
                    }
                }
            }
        }, h = function (z) {
            ...
            for (var y in x) {
                z.setAttribute(y, x[y])
            }
        }, l = function (y, x) {
            if (y.className.indexOf(x) !== 0) {
                y.className += " " + x;
                y.className = y.className.replace(/(^\s*)|(\s*$)/g, "")
            }
        }, o = function (z, x) {
            var y = new RegExp("(\\s|^)" + x + "(\\s|$)");
            z.className = z.className.replace(y, " ").replace(/(^\s*)|(\s*$)/g, "")
        }, t = function (A, z, y) {
            for (var x = 0; x < A.length; x++) {
                z.call(y, x, A[x])
            }
        };
        var j, n, i, w = a.createElement("style"), k = a.documentElement, v, p, u;
        var m = function (z, x) {
            var y;
            this.options = {
                animate: true,
            ...
            l(k, this.options.jsClass);
            this.wrapperEl = z.replace("#", "");
            if (a.getElementById(this.wrapperEl)) {
        ...
        m.prototype = {
            destroy: function () {
                ...
                o(j, "opened");
                o(j, n.navClass);
                o(j, n.navClass + "-" + this.index);
                o(k, n.navActiveClass);
                j.removeAttribute("style");
                j.removeAttribute("aria-hidden");
                r(d, "resize", this, false);
                r(d, "focus", this, false);
                r(a.body, "touchmove", this, false);
                r(i, "touchstart", this, false);
                r(i, "touchend", this, false);
                r(i, "mouseup", this, false);
                r(i, "keyup", this, false);
                r(i, "click", this, false);
                if (!n.customToggle) {
                ...
                if (!u) {
                    o(j, "closed");
                    l(j, "opened");
                    l(k, n.navActiveClass);
                    l(i, "active");
                    j.style.position = n.openPos;
                    s(j, {"aria-hidden": "false"});
                    u = true;
                    n.open()
                }
            }, close: function () {
                ...
                if (d.getComputedStyle(i, null).getPropertyValue("display") !== "none") {
                    p = true;
                    s(i, {"aria-hidden": "false"});
                    if (j.className.match(/(^|\s)closed(\s|$)/)) {
                        s(j, {"aria-hidden": "true"});
                        j.style.position = "absolute"
                    }
                    this._createStyles();
                ...
                q(d, "resize", this, false);
                q(d, "focus", this, false);
                q(a.body, "touchmove", this, false);
                q(i, "touchstart", this, false);
                q(i, "touchend", this, false);
                q(i, "mouseup", this, false);
                q(i, "keyup", this, false);
                q(i, "click", this, false);
                n.init()
            }, _createStyles: function () {
                if (!w.parentNode) {
                    w.type = "text/css";
                    a.getElementsByTagName("head")[0].appendChild(w)
                }
                ...
                if (!n.customToggle) {
                    var y = a.createElement("a");
                    y.innerHTML = n.label;
                    s(y, {"href": "#", "class": "nav-toggle"});
                    if (n.insert === "after") {
                        j.parentNode.insertBefore(y, j.nextSibling)
                    } else {
                        j.parentNode.insertBefore(y, j)
                    }
                    i = y
                } else {
                    var x = n.customToggle.replace("#", "");
                    if (a.getElementById(x)) {
                        i = a.getElementById(x)
                    } else {
                        if (a.querySelector(x)) {
                            i = a.querySelector(x)
                        } else {
                ...
                if (n.closeOnNavClick) {
                    var y = j.getElementsByTagName("a"), x = this;
                    t(y, function (z, A) {
                        q(y[z], "click", function () {
                            if (p) {
                                x.toggle()
                            }
                        }, false)
                ...
                this.startX = x.touches[0].clientX;
                this.startY = x.touches[0].clientY;
                this.touchHasMoved = false;
                r(i, "mouseup", this, false)
            }, _onTouchMove: function (x) {
                if (Math.abs(x.touches[0].clientX - this.startX) > 10 || Math.abs(x.touches[0].clientY - this.startY) > 10) {
                    this.touchHasMoved = true
                }
            }, _onTouchEnd: function (y) {
                this._preventDefault(y);
                if (!p) {
                    return
                }
                ...
                if (n.animate) {
                    var x = j.style, y = "max-height " + n.transition + "ms";
                    x.WebkitTransition = x.MozTransition = x.OTransition = x.transition = y
                }
            }, _calcHeight: function () {
                var z = 0;
                for (var y = 0; y < j.inner.length; y++) {
                    z += j.inner[y].offsetHeight
                }
                var x = "." + n.jsClass + " ." + n.navClass + "-" + this.index + ".opened{max-height:" + z + "px !important} ." + n.jsClass + " ." + n.navClass + "-" + this.index + ".opened.dropdown-active {max-height:9999px !important}";
                if (w.styleSheet) {
...
!function (h, j, e) {
    ...
    if (a && f) {
        ...
        l = k.placeholder = function () {
            var o = this;
            o.filter((a ? "textarea" : ":input") + "[placeholder]").not(".placeholder").on({
                "focus.placeholder": c,
                "blur.placeholder": g
        ...
        e(h).on("beforeunload.placeholder", function () {
            ...
            if (o.type == "password") {
                if (!r.data("placeholder-textinput")) {
                    try {
                        ...
                        s = e("<input>").prop(e.extend(i(this), {"type": "text"}))
                    }
                    s.removeAttr("name").data({
                        "placeholder-password": r,
                        "placeholder-id": q
                    }).on("focus.placeholder", c);
...
!function (c) {
    ...
    function a(f, e) {
        this.$field = c(f);
        this.options = c.extend(true, {}, d, e);
        this._defaults = d;
    ...
    a.prototype = {
        init: function () {
            ...
            var e = this, f;
            this.$field.on("keyup.ema", function (g) {
                f = c.trim(this.value);
                if (f) {
                    e.create(this, f);
                    e.doSelect(g.keyCode)
                } else {
                    e.hide()
                }
            ...
            var l = this, k, m, o, n = [], j, h, p, g, r, f, e = 2;
            i = c(i);
            j = i.offset();
            g = i.outerWidth(true) - e;
            r = i.outerHeight(true);
            h = j.left;
            p = j.top + r;
            f = "left: " + h + "px; top: " + p + "px; width: " + g + "px; border: 1px solid #e2e2e2; border-top: 0; display: none";
            o = c('<div class="' + this.options.sugClass + '-wrapper" style="' + f + '" />');
            n.push('<ul class="' + this.options.sugClass + '-list">');
            k = this.filter(q, this._domains);
            m = k.length;
            c.each(k, function (t, u) {
                var s = l.options.sugClass + "-item";
                if (l.selectedIndex > m - 1) {
                    if (t === 0) {
                        s += " active";
                        l.selectedIndex = 0
                    }
                } else {
                    if (t === l.selectedIndex) {
                        s += " active"
                    }
                }
                n.push('<li class="' + s + '" data-index="' + t + '">' + q.replace(/@.*/, "") + "@" + u + "</li>")
            });
            n.push("</ul>");
            n = n.join("");
            if (this.$suggest) {
                this.$suggest.empty();
                this.$suggest.append(n)
            } else {
                o.append(n);
                c("body").append(o);
                this.$suggest = o;
                this.$suggest.on("mouseenter click", "." + this.options.sugClass + "-item", function (u) {
                    var t, s;
                    s = c(this);
                    t = s.parent().children();
                    if (u.type === "mouseenter") {
                        s.addClass("active").siblings().removeClass("active");
                        l.selectedIndex = c.inArray(this, t)
                    } else {
                        l.$field.val(t.eq(l.selectedIndex).text());
                        l.hide()
                    }
                })
            }
            ...
            var f = c("." + this.options.sugClass + "-item", this.$suggest), g = 0, e = f.length - 1;
            switch (h) {
                case 13:
                    c("li.active", this.$suggest).trigger("click");
                    this.selectedIndex = 0;
                    break;
                case 38:
                    this.selectedIndex--;
                    ...
                    f.removeClass("active").eq(this.selectedIndex).addClass("active");
                    break;
                case 40:
                    this.selectedIndex++;
    ...
    c.fn[b] = function (e) {
        return this.each(function () {
            if (!c.data(this, b)) {
                c.data(this, b, new a(this, e))
            }
        })
    }
}(window.jQuery);
!function (a) {
    a.fn.Huispinner = function (c, e) {
        var d = {value: 1, minValue: 1, maxValue: 999, dis: 1,};
        var c = a.extend(d, c);
        var b = {up: 38, down: 40};
        this.each(function () {
            var g = a(this);
            var k = '<div class="spinner">' + '<a class="subtract" href="javascript:void(0)"><i>-</i></a>' + '<input class="amount input-text" value="' + c.value + '" autocomplete="off">' + '<a class="add" href="javascript:void(0)"><i>+</i></a>' + "</div>";
            g.append(k);
            var f = g.find(".input-text"), j = g.find(".subtract"), i = g.find(".add"), h = parseInt(f.val());
            if (h <= c.minValue) {
                j.addClass("disabled");
            ...
            j.on("click", function () {
                var l = parseInt(f.val());
                f.val(l <= c.minValue ? c.minValue : l - c.dis);
                i.removeClass("disabled");
                if (f.val() <= c.minValue) {
                    f.val(c.minValue);
                    j.addClass("disabled")
            ...
            i.on("click", function () {
                var l = parseInt(f.val());
                f.val(l >= c.maxValue ? c.maxValue : l + c.dis);
                j.removeClass("disabled");
                if (f.val() >= c.maxValue) {
                    f.val(c.maxValue);
                    i.addClass("disabled")
...
!function (a) {
    a.extend({
        format: function (j, b, k) {
            j = j.toString();
            var h = j.length;
            if (h > b) {
                var d = h % b, c = parseInt(h / b), g = [], f = j.substr(0, d);
                if (f != "") {
                    g.push(f)
                }
                for (var e = 0; e < c; e++) {
                    g.push(j.substr(d + e * b, b))
                }
                j = g.join(k)
            }
            return j
...
!function (a) {
    a.fn.togglePassword = function (c) {
        var d = a.extend(a.fn.togglePassword.defaults, c), b = a(this);
        a(d.el).on(d.ev, function () {
            "password" == a(b).attr("type") ? a(b).attr("type", "text") : a(b).attr("type", "password")
        })
    };
    a.fn.togglePassword.defaults = {ev: "click"}
}(window.jQuery);
!(function (c) {
    ...
    c.fn[g] = function (N, E) {
        var J = 'input[type="' + q + '"], input[type="' + a + '"]', L = c(), B = function (O) {
            O.each(function () {
                var P = c(this);
                if (P.is(J)) {
                    L = L.add(P)
        ...
        if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(N)) {
            ...
            if (typeof N == "object" || !N) {
                ...
                return L.each(function () {
                    var Z = c(this);
                    u(Z);
                    var R = this, O = R.id, S = -D + "%", aa = 100 + (D * 2) + "%", T = {
                            position: "absolute",
                            top: S,
                            left: S,
                            display: "block",
                            ...
                            border: 0,
                            opacity: 0
                        }, U = n ? {position: "absolute", visibility: "hidden"} : D ? T : {
                            position: "absolute",
                            opacity: 0
                        }, V = R[t] == q ? F.checkboxClass || "i" + q : F.radioClass || "i" + a,
                        X = c(z + '[for="' + O + '"]').add(Z.closest(z)), W = !!F.aria,
                        Q = g + "-" + Math.random().toString(36).substr(2, 6),
                        Y = '<div class="' + V + '" ' + (W ? 'role="' + R[t] + '" ' : ""), P;
                    if (W) {
                        X.each(function () {
                            Y += 'aria-labelledby="';
                            if (this.id) {
                    ...
                    P.on(d + " mousedown mouseup mouseover mouseout " + w, function (ad) {
                        var ac = ad[t], ab = /wn|up/.test(ac) ? K : I;
                        if (!R[i]) {
                            if (ac == d) {
                                v(Z, false, true)
                            } else {
    ...
    function v(B, H, G) {
        var C = B[0], E = /er/.test(G) ? b : /bl/.test(G) ? i : s, F = G == r ? {
            checked: C[s],
            disabled: C[i],
    ...
    function k(K, D, B) {
        var G = K[0], M = K.parent(), L = D == s, C = D == b, H = D == i, N = C ? h : L ? x : "enabled",
            F = m(K, N + j(G[t])), J = m(K, D + j(G[t]));
        if (G[D] !== true) {
            if (!B && D == s && G[t] == a && G.name) {
                var E = K.closest("form"), I = 'input[name="' + G.name + '"]';
    ...
    function y(I, D, B) {
        var F = I[0], K = I.parent(), J = D == s, C = D == b, G = D == i, L = C ? h : J ? x : "enabled",
            E = m(I, L + j(F[t])), H = m(I, D + j(F[t]));
        if (F[D] !== false) {
            if (C || !B || B == "force") {
                F[D] = false
            }
        ...
        init: function (c) {
            ...
            if (this.opt.target) {
                ...
                if (this.opt.targetFormat.indexOf("{score}") < 0) {
                    a.error.call(this, '模版 "{score}" 找不到!')
                }
                if (e !== null) {
...
!(function (a) {
    a.fn.onePageNav = function (b) {
        var c = a.extend({}, a.fn.onePageNav.defaults, b), d = {};
        d.sections = {};
        d.bindNav = function (f, h, i) {
            var g = f.parent(), e = f.attr("href"), j = a(window);
            if (!g.hasClass(i.currentClass)) {
                if (i.begin) {
                    i.begin()
                }
                d.adjustNav(h, g, i.currentClass);
                j.unbind(".onePageNav");
                a.scrollTo(e, i.scrollSpeed, {
                    easing: i.easing, offset: {top: -i.scrollOffset}, onAfter: function () {
                        if (i.changeHash) {
                            window.location.hash = e
                        }
                        j.bind("scroll.onePageNav", function () {
                            d.scrollChange(h, i)
                        });
                        if (i.end) {
                            i.end()
        ...
        d.getPositions = function (f, g) {
            var e = f.find("a");
            if (g.filter !== "") {
                e = e.filter(g.filter)
            }
            e.each(function () {
                var j = a(this).attr("href"), i = a(j).offset(), h = i.top;
                d.sections[j.substr(1)] = Math.round(h) - g.scrollOffset
            })
        };
        d.getSection = function (i, g) {
            var e = "", h = Math.round(a(window).height() * g.scrollThreshold);
        ...
        d.scrollChange = function (g, h) {
            d.getPositions(g, h);
            var f = a(window).scrollTop(), e = d.getSection(f, h);
            if (e !== "") {
                d.adjustNav(g, g.find("a[href=#" + e + "]").parent(), h.currentClass)
            }
        };
        d.init = function (g, h) {
            var f = false, e = g.find("a");
            if (h.filter !== "") {
                e = e.filter(h.filter)
            }
            e.bind("click", function (i) {
                d.bindNav(a(this), g, h);
                i.preventDefault()
            });
            d.getPositions(g, h);
            a(window).bind("scroll.onePageNav", function () {
                f = true
            });
        ...
        return this.each(function () {
            var e = a(this), f = a.meta ? a.extend({}, c, e.data()) : c;
            d.init(e, f)
        })
    };
...
(function (e) {
    var b = "Hui.colorPicker";
    var d = '<div class="colorpicker"><button type="button" class="btn dropdown-toggle" data-toggle="dropdown"><span class="cp-title"></span><i class="ic"></i></button><ul class="dropdown-menu clearfix"></ul></div>';
    var a = {zh_cn: {errorTip: "不是有效的颜色值"}, zh_tw: {errorTip: "不是有效的顏色值"}, en: {errorTip: "Not a valid color value"}};
    var c = function (g, f) {
        this.name = b;
        this.$ = e(g);
        this.getOptions(f);
    ...
    c.prototype.init = function () {
        var f = this.options, h = this;
        this.$picker = e(d).addClass(f.wrapper);
        this.$picker.find(".cp-title").toggle(f.title !== undefined).text(f.title);
        this.$menu = this.$picker.find(".dropdown-menu").toggleClass("pull-right", f.pullMenuRight);
        this.$btn = this.$picker.find(".btn.dropdown-toggle");
        this.$btn.find(".ic").addClass("icon-" + f.icon);
        if (f.btnTip) {
        ...
        this.colors = {};
        e.each(this.options.colors, function (j, l) {
            if (e.zui.Color.isColor(l)) {
                var k = new e.zui.Color(l);
                h.colors[k.toCssStr()] = k
            }
        });
        this.updateColors();
        var h = this;
        this.$picker.on("click", ".cp-tile", function () {
            h.setValue(e(this).data("color"))
        });
        var i = this.$;
        var g = function () {
            var k = i.val();
            var j = e.zui.Color.isColor(k);
            i.parent().toggleClass("has-error", !j && !(f.optional && k === ""));
            if (j) {
                h.setValue(k, true)
            } else {
                if (f.optional && k === "") {
                    ...
                    if (!i.is(":focus")) {
                        i.tooltip("show", f.errorTip)
                    }
                }
            }
        };
        if (i.is("input:not([type=hidden])")) {
            if (f.tooltip) {
                i.attr("data-toggle", "tooltip").tooltip({
                    trigger: "manual",
                    placement: f.tooltip,
            ...
            i.on("keyup paste input change", g)
        } else {
            i.appendTo(this.$picker)
        }
        g()
    };
    c.prototype.addColor = function (f) {
        var h = f.toCssStr(), g = this.options;
        if (!this.colors[h]) {
            this.colors[h] = f
        }
        var i = e('<a href="###" class="cp-tile"></a>', {titile: f}).data("color", f).css({
            "color": f.contrast().toCssStr(),
            "background": h,
            "border-color": f.luma() > 0.43 ? "#ccc" : "transparent"
        }).attr("data-color", h);
        this.$menu.append(e("<li/>").css({width: g.tileSize, height: g.tileSize}).append(i));
        if (g.optional) {
            this.$menu.find(".cp-tile.empty").parent().detach().appendTo(this.$menu)
        }
    };
    c.prototype.updateColors = function (g) {
        var k = this.$picker, i = this.$menu.empty(), h = this.options, g = g || this.colors, j = this;
        var f = 0;
        ...
        if (h.optional) {
            var l = e('<li><a class="cp-tile empty" href="###"></a></li>').css({width: h.tileSize, height: h.tileSize});
            this.$menu.append(l);
            f++
        }
        i.css("width", Math.min(f, h.lineCount) * h.tileSize + 6)
    };
    c.prototype.setValue = function (f, i) {
        var g = this.options;
        this.$menu.find(".cp-tile.active").removeClass("active");
        var h = "";
        if (f) {
            var j = new e.zui.Color(f);
            h = j.toCssStr().toLowerCase();
            this.$btn.css({background: h, color: j.contrast().toCssStr(), borderColor: j.luma() > 0.43 ? "#ccc" : h});
            if (!this.colors[h]) {
                this.addColor(j)
            }
            if (!i && this.$.val().toLowerCase() !== h) {
                this.$.val(h).trigger("change")
            }
            this.$menu.find(".cp-tile[data-color=" + h + "]").addClass("active");
            this.$.tooltip("hide");
            this.$.trigger("colorchange", j)
        } else {
        ...
        if (g.updateBorder) {
            e(g.updateBorder).css("border-color", h)
        }
        if (g.updateBackground) {
            e(g.updateBackground).css("background-color", h)
        }
        if (g.updateColor) {
            e(g.updateText).css("color", h)
        }
        if (g.updateText) {
            e(g.updateText).text(h)
        }
    };
    c.prototype.getOptions = function (f) {
        var g = e.extend({}, c.DEFAULTS, this.$.data(), f);
        if (typeof g.colors === "string") {
            g.colors = g.colors.split(",")
        }
        var h = (g.lang || e.zui.clientLang()).toLowerCase();
        if (!g.errorTip) {
            g.errorTip = a[h].errorTip
        }
        if (!e.fn.tooltip) {
            g.btnTip = false
        }
    ...
    e.fn.colorPicker = function (f) {
        return this.each(function () {
            var i = e(this);
            var h = i.data(b);
            var g = typeof f == "object" && f;
            if (!h) {
                i.data(b, (h = new c(this, g)))
            }
            if (typeof f == "string") {
                h[f]()
            }
    ...
    e.fn.colorPicker.Constructor = c;
    e(function () {
        e('[data-provide="colorpicker"]').colorPicker()
    })
}(jQuery));

function HuiaddFavorite(b) {
    b.site = b.site || window.location.href;
    b.name = b.name || document.title;
    try {
        window.external.addFavorite(b.site, b.name)
    } catch (a) {
        try {
...
function Huisethome(c) {
    try {
        c.style.behavior = "url(#default#homepage)";
        c.setHomePage(webSite)
    } catch (b) {
        if (window.netscape) {
            try {
    ...
    a.fn.Huihover = function (b) {
        ...
        this.each(function () {
            ...
            d.hover(function () {
                ...
                d.removeClass(b.className)
            })
        })
    }
}(window.jQuery);
!function (a) {
    a.fn.Huifocusblur = function (b) {
        var c = {className: "focus",};
        var b = a.extend(c, b);
        this.each(function () {
            var d = a(this);
            d.focus(function () {
                d.addClass(b.className).removeClass("inputError")
            });
            d.blur(function () {
                d.removeClass(b.className)
            })
...
!function (a) {
    a.Huiselect = function (c, d) {
        var b = a(d);
        a(c + " cite").click(function () {
            var e = a(c + " ul");
            e.slideToggle()
        });
        a(c + " ul li a").click(function () {
            var e = a(this).text();
            a(c + " cite").html(e);
            var f = a(this).attr("selectid");
            b.val(f);
            a(c + " ul").hide()
        });
...
!function (a) {
    a.fn.Huitab = function (b) {
        var c = {tabBar: ".tabBar span", tabCon: ".tabCon", className: "current", tabEvent: "click", index: 0,};
        var b = a.extend(c, b);
        this.each(function () {
            var d = a(this);
            d.find(b.tabBar).removeClass(b.className);
            d.find(b.tabBar).eq(b.index).addClass(b.className);
            d.find(b.tabCon).hide();
            d.find(b.tabCon).eq(b.index).show();
            d.find(b.tabBar).on(b.tabEvent, function () {
                d.find(b.tabBar).removeClass(b.className);
                a(this).addClass(b.className);
                var e = d.find(b.tabBar).index(this);
                d.find(b.tabCon).hide();
                d.find(b.tabCon).eq(e).show()
            })
        })
    }
}(window.jQuery);
...
!function (a) {
    a.fn.Huitags = function (c) {
        var d = {value: "Hui前端框架,H-ui,辉哥", maxlength: 20, number: 5, tagsDefault: ["Html", "CSS", "JS"],};
        var c = a.extend(d, c);
        var b = {Enter: 13, Enter2: 108, Spacebar: 32};
        this.each(function () {
            var j = a(this);
            var n = '<div class="Huitags-wraper">' + '<div class="Huitags-editor cl"></div>' + '<div class="Huitags-input-wraper">' + '<input type="text" class="input-text Huitags-input" maxlength="' + c.maxlength + '" value="">' + "</div>" + '<div class="Huitags-list">' + '<div class="Huitags-notag" style="display:none">暂无常用标签</div>' + '<div class="Huitags-has"></div>' + "</div>" + '<input type="hidden" class="Huitags-val" name="" value="' + c.value + '">' + "</div>";
            j.append(n);
            var h = j.find(".Huitags-wraper");
            var k = j.find(".Huitags-editor");
            var p = j.find(".Huitags-input");
            var l = j.find(".Huitags-list");
            var q = j.find(".Huitags-has");
            var e = j.find(".Huitags-val");
            if (c.tagsDefault) {
                var m = (c.tagsDefault).length;
                for (var g = 0; g < m; g++) {
                    q.append("<span>" + c.tagsDefault[g] + "</span>")
                }
                q.find("span").on("click", function () {
                    var i = a(this).text();
                    i = i.replace(/(^\s*)|(\s*$)/g, "");
                    k.append('<span class="Huitags-token">' + i + "</span>");
                    o(this);
                    a(this).remove()
                })
            }
            ...
            p.on("keydown", function (t) {
                ...
                if (i.keyCode == b.Enter || i.keyCode == b.Enter2 || i.keyCode == b.Spacebar) {
                    var r = p.val().replace(/\s+/g, "");
                    var s = /^,|,$/gi;
                    r = r.replace(s, "");
                    r = a.trim(r);
                    if (r != "") {
            ...
            p.on("change", function () {
                ...
                var r = u + "," + w;
                if (r != "") {
                    var t = '<i class="Huitags-icon Hui-iconfont">&#xe64b;</i>';
                    var i = f(r, 1);
                    if (i.length > 0) {
                        for (var s = 0; s < i.length; s++) {
                            t += '<span class="Huitags-token">' + i[s] + "</span>"
                        }
                        e.val(i);
                        k.html(t);
                        p.val("").blur()
            ...
            a(document).on("click", ".Huitags-token", function () {
                a(this).remove();
                var s = "";
                if (j.find(".Huitags-token").length < 1) {
                    e.val("");
                    return false
                } else {
                    for (var r = 0; r < j.find(".Huitags-token").length; r++) {
                        s += j.find(".Huitags-token").eq(r).text() + ","
                    }
...
!function (a) {
    a.Huitagsmixed = function (b) {
        a(b).each(function () {
            var c = 9;
            var e = 0;
            var d = parseInt(Math.random() * (c - e + 1) + e);
            a(this).addClass("tags" + d)
        })
    }
}(window.jQuery);
!function (a) {
    a.fn.Huitextarealength = function (b) {
        var c = {minlength: 0, maxlength: 140, errorClass: "error", exceed: true,};
        var b = a.extend(c, b);
        this.each(function () {
            var f = a(this);
            var e = f.val();
            var d = e.length;
            var g = '<p class="textarea-numberbar"><em class="textarea-length">' + d + "</em>/" + b.maxlength + "</p>";
            f.parent().append(g);
            f.on("keyup", function () {
                e = f.val();
                d = e.length;
                if (d > b.maxlength) {
                    if (b.exceed) {
                        f.addClass(b.errorClass)
                    } else {
                        e = e.substring(0, b.maxlength);
                        f.val(e);
                        f.removeClass(b.errorClass)
                    }
                } else {
                    if (d < b.minlength) {
                        f.addClass(b.errorClass)
                ...
                f.parent().find(".textarea-length").text(e.length)
            })
        })
    }
}(window.jQuery);
!function (a) {
    a.fn.Huipreview = function (b) {
        var c = {className: "active", bigImgWidth: 300,};
        var b = a.extend(c, b);
        this.each(function () {
            var d = a(this);
            var e;
            d.hover(function () {
                ...
                e = setTimeout(function () {
                    a("#tooltip-preview").remove();
                    var f = d.find("img").attr("src");
                    var n = d.attr("data-src");
                    var l = d.attr("data-width");
                    var t = d.attr("data-height");
                    var q = a(window).width();
                    var o = q / 2;
                    var r = d.parent().offset().top;
                    var g = d.parent().offset().left;
                    var p = d.parent().width();
                    var k = d.parent().height();
                    var m = (g + p / 2);
                    var s = "auto", h = "auto";
                    if (m < o) {
                        s = (p + g) + "px"
                    ...
                    if (n == "") {
                        ...
                        var j = '<div id="preview-wraper" style="position: absolute;width:' + b.bigImgWidth + "px;height:auto;top:" + r + "px;right:" + h + ";left:" + s + '">' + '<img src="' + f + '" width="' + b.bigImgWidth + '">' + "</div>";
                        a("body").append(j);
                        var i = new Image();
                        i.src = n;
                        i.onload = function () {
                            a("#preview-wraper").find("img").attr("src", n).css("width", b.bigImgWidth)
                        }
                    }
                }, 500)
            }, function () {
                clearTimeout(e);
                d.removeClass(b.className);
                a("#preview-wraper").remove()
            })
        })
    }
}(window.jQuery);
!function (a) {
    a.Huimodalalert = function (c, b) {
        if (a(".modal-alert").length > 0) {
            a(".modal-alert").remove()
        }
        if (b == 0 || typeof (b) == "undefined") {
            a(document.body).append('<div id="modal-alert" class="modal modal-alert radius">' + '<div class="modal-alert-info">' + c + "</div>" + '<div class="modal-footer"> <button class="btn btn-primary radius" onClick="$.Huimodal_alert.hide()">确定</button></div>' + "</div>");
            a("#modal-alert").fadeIn()
        } else {
            a(document.body).append('<div id="modal-alert" class="modal modal-alert radius">' + '<div class="modal-alert-info">' + c + "</div>" + "</div>");
            a("#modal-alert").fadeIn();
            setTimeout(a.Huimodalalert.hide, b)
        }
    };
    a.Huimodalalert.hide = function () {
        a("#modal-alert").fadeOut("normal", function () {
            a("#modal-alert").remove()
        })
    }
}(window.jQuery);
!function (a) {
    a.Huialert = function () {
        a(".Huialert i").Huihover();
        a(".Huialert i").on("click", function () {
            var b = a(this).parents(".Huialert");
            b.fadeOut("normal", function () {
                b.remove()
            })
        })
    };
...
!function (a) {
    a.Huitotop = function (b) {
        if (!b) {
            b = 60
        }
        var d = '<a href="javascript:void(0)" class="tools-right toTop Hui-iconfont" title="返回顶部" alt="返回顶部" style="display:none;bottom:' + b + 'px">&#xe684;</a>';
        a(d).appendTo(a("body")).click(function () {
...
!function (a) {
    a.Huimarquee = function (i, e, f) {
        var b;
        var j = false;
        var c = document.getElementById("marquee");
        if (document.getElementById("holder").offsetHeight <= i) {
            return
        }
        var h = c.innerHTML.replace("holder", "holder2");
        c.innerHTML += h;
        ...
        var g = function () {
            if (c.scrollTop % i != 0) {
                c.scrollTop += 2;
                if (c.scrollTop >= c.scrollHeight / 2) {
                    c.scrollTop = 0
                }
            } else {
                clearInterval(b);
...
$(function () {
    ...
    $(document).on("change", ".input-file", function () {
        var a = $(this).val();
        $(this).parent().find(".upload-url").val(a).focus().blur()
    })
});
!function (d) {
    var b = function (f, e) {
    ...
    d(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function (g) {
        ...
        d(f.target).closest(".btn").toggleClass("focus", f.type == "focus")
    })
}(jQuery);
jQuery(function (a) {
    a(document).ready(function () {
        ...
        a.fn.stickUp = function (q) {
            a(this).addClass("stuckMenu");
            var p = 0;
            if (q != null) {
                for (var r in q.parts) {
                    if (q.parts.hasOwnProperty(r)) {
                        h[p] = q.parts[p];
                        p++
                    }
                }
                ...
                if (q.topMargin != null) {
                    if (q.topMargin == "auto") {
                        f = parseInt(a(".stuckMenu").css("margin-top"))
                    } else {
                        if (isNaN(q.topMargin) && q.topMargin.search("px") > 0) {
                            f = parseInt(q.topMargin.replace("px", ""))
                        } else {
                            if (!isNaN(parseInt(q.topMargin))) {
                                f = parseInt(q.topMargin)
                            } else {
            ...
            m = parseInt(a(this).height());
            k = parseInt(a(this).css("margin-bottom"));
            d = parseInt(a(this).next().closest("div").css("margin-top"));
            j = parseInt(a(this).offset().top)
        };
        a(document).on("scroll", function () {
            varscroll = parseInt(a(document).scrollTop());
            if (c != null) {
                for (var o = 0; o < c; o++) {
                    n[o] = a("#" + h[o] + "").offset().top;

                    function p(q) {
                        contentView = a("#" + h[q] + "").height() * 0.4;
                        testView = n[q] - contentView;
                    ...
                    if (i == "down" && varscroll > n[o] - 50 && varscroll < n[o] + 50) {
                        a("." + l).removeClass(b);
                        a("." + l + ":eq(" + o + ")").addClass(b)
                    }
                    if (i == "up") {
            ...
            if (j < varscroll + f) {
                a(".stuckMenu").addClass("isStuck");
                a(".stuckMenu").next().closest("div").css({"margin-top": m + k + d + "px"}, 10);
                a(".stuckMenu").css("position", "fixed");
                a(".isStuck").css({top: "0px"}, 10, function () {
                })
            }
            if (varscroll + f < j) {
                a(".stuckMenu").removeClass("isStuck");
                a(".stuckMenu").next().closest("div").css({"margin-top": d + "px"}, 10);
                a(".stuckMenu").css("position", "relative")
            }
        })
    })
});
!function (d) {
    ...
    b.prototype.backdrop = function (i) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            this.$backdrop = d('<div class="modal-backdrop ' + f + '" />').prependTo(this.$element).on("click.dismiss.bs.modal", d.proxy(function (j) {
                if (j.target !== j.currentTarget) {
                    return this.options.backdrop == "static" ? this.$element[0].focus.call(this.$element[0]) : this.hide.call(this)
                }
            }, this));
            if (e) {
    ...
    function d(i) {
        ...
        h(b).each(function () {
            ...
            if (i && i.type == "click" && /input|textarea/i.test(i.target.tagName) && h.contains(k[0], i.target)) {
                return k.trigger(i = h.Event("hide.bs.dropdown", j))
            }
    ...
    a.prototype.toggle = function (m) {
        ...
        if (!j) {
            ...
            if (m.isDefaultPrevented()) {
                return l.trigger("focus").attr("aria-expanded", "true")
            }
...
!function (d) {
    ...
    c.prototype.applyPlacement = function (j, k) {
        ...
        d.offset.setOffset(l[0], d.extend({
            using: function (r) {
                l.css({top: Math.round(r.top), left: Math.round(r.left)})
            }
        }, j), 0);
        l.addClass("in");
    ...
    c.prototype.hide = function (j) {
        ...
        i.removeClass("in");
        d.support.transition && this.$tip.hasClass("fade") ? i.one("bsTransitionEnd", f).emulateTransitionEnd(c.TRANSITION_DURATION) : f();
    ...
    c.prototype.getPosition = function (g) {
        ...
        if (h.width == null) {
            h = d.extend({}, h, {width: h.right - h.left, height: h.bottom - h.top})
        }
    ...
    c.prototype.getCalculatedOffset = function (e, h, f, g) {
        return e == "bottom" ? {
            ...
            top: h.top - g,
            left: h.left + h.width / 2 - f / 2
        } : e == "left" ? {top: h.top + h.height / 2 - g / 2, left: h.left - f} : {
...
(function (a, b) {
        ...
        function c(h) {
            ...
            function j(k) {
                ...
                k.prototype.option = function (l) {
                    ...
                    this.options = h.extend(true, this.options, l)
                }
            }

            var g = typeof console === "undefined" ? d : function (k) {
                console.error(k)
            };
                ...
                h.fn[k] = function (p) {
                    if (typeof p === "string") {
                        ...
                        for (var q = 0, n = this.length; q < n; q++) {
                            ...
                            var m = h.data(s, k);
                            if (!m) {
                                g("cannot call methods on " + k + " prior to initialization; " + "attempted to call '" + p + "'");
                                continue
                            }
                            if (!h.isFunction(m[p]) || p.charAt(0) === "_") {
                                g("no such method '" + p + "' for " + k + " instance");
                                continue
                            }
                            var r = m[p].apply(m, o);
                            if (r !== undefined && r !== m) {
    ...
    (function (e) {
        var f = {
            formatInvalidInputErrorMsg: function (g) {
                return "Invalid input value '" + g + "' passed in"
            },
        ...
        function c(k, m) {
            if (typeof k === "string") {
                this.element = document.querySelector(k)
            } else {
                if (k instanceof HTMLElement) {
                    this.element = k
                }
            }
            var v = this.element.style.width;
            var j = false;
            ...
            if (this.sliderElem) {
                ...
                g.className = "slider-track";
                n = document.createElement("div");
                n.className = "slider-selection";
                h = document.createElement("div");
                h.className = "slider-handle min-slider-handle";
                ...
                q.className = "tooltip tooltip-main";
                p(q);
                var l = document.createElement("div");
                l.className = "tooltip tooltip-min";
                p(l);
                var o = document.createElement("div");
                o.className = "tooltip tooltip-max";
                p(o);
                this.sliderElem.appendChild(g);
                this.sliderElem.appendChild(q);
                this.sliderElem.appendChild(l);
                this.sliderElem.appendChild(o);
                s.insertBefore(this.sliderElem, this.element);
            ...
            m = m ? m : {};
            var t = Object.keys(this.defaultOptions);
            for (var x = 0; x < t.length; x++) {
                var r = t[x];
                var A = m[r];
                A = (typeof A !== "undefined") ? A : z(this.element, r);
                A = (A !== null) ? A : this.defaultOptions[r];
                if (!this.options) {
                    this.options = {}
                }
                this.options[r] = A
            ...
            if (j === true) {
                ...
                ["left", "top", "width", "height"].forEach(function (i) {
                    this._removeProperty(this.trackSelection, i)
                }, this);
                [this.handle1, this.handle2].forEach(function (i) {
                    this._removeProperty(i, "left");
                    this._removeProperty(i, "top")
                }, this);
                [this.tooltip, this.tooltip_min, this.tooltip_max].forEach(function (i) {
                    this._removeProperty(i, "left");
                    this._removeProperty(i, "top");
                    this._removeProperty(i, "margin-left");
                    this._removeProperty(i, "margin-top");
                    this._removeClass(i, "right");
                    this._removeClass(i, "top")
                }, this)
            }
            ...
            this.trackSelection = n || this.trackSelection;
            ...
            var w = y.indexOf(this.options.handle) !== -1;
            if (w) {
        ...
        a.prototype = {
            ...
            setValue: function (k, i) {
                if (!k) {
                    k = 0
                }
                var h = this.getValue();
                this.options.value = this._validateInputValue(k);
                var g = this._applyPrecision.bind(this);
                if (this.options.range) {
                    this.options.value[0] = g(this.options.value[0]);
                    this.options.value[1] = g(this.options.value[1]);
                    this.options.value[0] = Math.max(this.options.min, Math.min(this.options.max, this.options.value[0]));
                    this.options.value[1] = Math.max(this.options.min, Math.min(this.options.max, this.options.value[1]))
                } else {
                    this.options.value = g(this.options.value);
                ...
                if (this.diff > 0) {
                    this.percentage = [(this.options.value[0] - this.options.min) * 100 / this.diff, (this.options.value[1] - this.options.min) * 100 / this.diff, this.options.step * 100 / this.diff]
                } else {
                    this.percentage = [0, 0, 100]
                }
                this._layout();
                var j = this.options.range ? this.options.value : this.options.value[0];
                if (i === true) {
                    this._trigger("slide", j)
                }
                if (h !== j) {
                    this._trigger("change", {oldValue: h, newValue: j})
                }
                this._setDataVal(j);
                return this
            },
            ...
            on: function (g, h) {
                if (e) {
                    this.$element.on(g, h);
                    this.$sliderElem.on(g, h)
                } else {
                    this._bindNonQueryEventHandler(g, h)
                }
                return this
            },
            ...
            refresh: function () {
                ...
                if (e) {
                    e.data(this.element, "slider", this)
                }
                return this
            },
            relayout: function () {
            ...
            _bindNonQueryEventHandler: function (g, h) {
                if (this.eventToCallbackMap[g] === undefined) {
                    this.eventToCallbackMap[g] = []
                }
                this.eventToCallbackMap[g].push(h)
            },
            _cleanUpEventCallbacksMap: function () {
                var j = Object.keys(this.eventToCallbackMap);
                for (var h = 0; h < j.length; h++) {
                    var g = j[h];
                    this.eventToCallbackMap[g] = null
                }
            },
            ...
            _layout: function () {
                ...
                if (this.options.reversed) {
                    l = [100 - this.percentage[0], this.percentage[1]]
                } else {
                    l = [this.percentage[0], this.percentage[1]]
                }
                this.handle1.style[this.stylePos] = l[0] + "%";
                this.handle2.style[this.stylePos] = l[1] + "%";
                if (this.options.orientation === "vertical") {
                    this.trackSelection.style.top = Math.min(l[0], l[1]) + "%";
                    this.trackSelection.style.height = Math.abs(l[0] - l[1]) + "%"
                } else {
                    this.trackSelection.style.left = Math.min(l[0], l[1]) + "%";
                    this.trackSelection.style.width = Math.abs(l[0] - l[1]) + "%";
                    var k = this.tooltip_min.getBoundingClientRect();
                    var h = this.tooltip_max.getBoundingClientRect();
                    if (k.right > h.left) {
                ...
                var j;
                if (this.options.range) {
                    j = this.options.formatter(this.options.value);
                    this._setText(this.tooltipInner, j);
                    this.tooltip.style[this.stylePos] = (l[1] + l[0]) / 2 + "%";
                    if (this.options.orientation === "vertical") {
                    ...
                    var g = this.options.formatter(this.options.value[0]);
                    this._setText(this.tooltipInner_min, g);
                    var i = this.options.formatter(this.options.value[1]);
                    this._setText(this.tooltipInner_max, i);
                    this.tooltip_min.style[this.stylePos] = l[0] + "%";
                    if (this.options.orientation === "vertical") {
                        this._css(this.tooltip_min, "margin-top", -this.tooltip_min.offsetHeight / 2 + "px")
                    } else {
                        this._css(this.tooltip_min, "margin-left", -this.tooltip_min.offsetWidth / 2 + "px")
                    }
                    this.tooltip_max.style[this.stylePos] = l[1] + "%";
                    if (this.options.orientation === "vertical") {
                    ...
                    j = this.options.formatter(this.options.value[0]);
                    this._setText(this.tooltipInner, j);
                    this.tooltip.style[this.stylePos] = l[0] + "%";
                    if (this.options.orientation === "vertical") {
                        this._css(this.tooltip, "margin-top", -this.tooltip.offsetHeight / 2 + "px")
                    } else {
                        this._css(this.tooltip, "margin-left", -this.tooltip.offsetWidth / 2 + "px")
            ...
            _removeProperty: function (g, h) {
                if (g.style.removeProperty) {
                    g.style.removeProperty(h)
                } else {
                    g.style.removeAttribute(h)
                }
            },
            _mousedown: function (h) {
                ...
                this.offset = this._offset(this.sliderElem);
                this.size = this.sliderElem[this.sizePos];
                var g = this._getPercentage(h);
                if (this.options.range) {
                    var k = Math.abs(this.percentage[0] - g);
                    var j = Math.abs(this.percentage[1] - g);
                    this.dragged = (k < j) ? 0 : 1
                } else {
                    this.dragged = 0
                }
                this.percentage[this.dragged] = this.options.reversed ? 100 - g : g;
                this._layout();
                if (this.touchCapable) {
                ...
                this._trigger("slideStart", i);
                this._setDataVal(i);
                this.setValue(i);
                this._pauseEvent(h);
                return true
            },
            _triggerFocusOnHandle: function (g) {
                if (g === 0) {
                    this.handle1.focus()
                }
                if (g === 1) {
            ...
            _keydown: function (l, k) {
                ...
                if (this.options.natural_arrow_keys) {
                    var g = (this.options.orientation === "vertical" && !this.options.reversed);
                    var i = (this.options.orientation === "horizontal" && this.options.reversed);
                    if (g || i) {
                        j = j * -1
                    }
                }
                var n = j * this.percentage[2];
                var h = this.percentage[l] + n;
                if (h > 100) {
                    h = 100
                } else {
                    if (h < 0) {
                ...
                this._trigger("slideStart", m);
                this._setDataVal(m);
                this.setValue(m, true);
                this._trigger("slideStop", m);
                this._setDataVal(m);
                this._pauseEvent(k);
                return false
            },
            _pauseEvent: function (g) {
            ...
            _adjustPercentageForRangeSliders: function (g) {
                if (this.options.range) {
                    if (this.dragged === 0 && this.percentage[1] < g) {
                        this.percentage[0] = this.percentage[1];
                        this.dragged = 1
                    } else {
                        if (this.dragged === 1 && this.percentage[0] > g) {
            ...
            _calculateValue: function () {
                var g;
                if (this.options.range) {
                    g = [this.options.min, this.options.max];
                    if (this.percentage[0] !== 0) {
                        g[0] = (Math.max(this.options.min, this.options.min + Math.round((this.diff * this.percentage[0] / 100) / this.options.step) * this.options.step));
                        g[0] = this._applyPrecision(g[0])
                    }
                    if (this.percentage[1] !== 100) {
                        g[1] = (Math.min(this.options.max, this.options.min + Math.round((this.diff * this.percentage[1] / 100) / this.options.step) * this.options.step));
                        g[1] = this._applyPrecision(g[1])
                    }
                } else {
                    g = (this.options.min + Math.round((this.diff * this.percentage[0] / 100) / this.options.step) * this.options.step);
                    if (g < this.options.min) {
                        g = this.options.min
                    } else {
                        if (g > this.options.max) {
                            g = this.options.max
                        }
                    }
                    g = parseFloat(g);
                    g = this._applyPrecision(g)
                }
                return g
            },
            _applyPrecision: function (h) {
                var g = this.options.precision || this._getNumDigitsAfterDecimalPlace(this.options.step);
                return this._applyToFixedAndParseFloat(h, g)
            },
            _getNumDigitsAfterDecimalPlace: function (h) {
                var g = ("" + h).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);
                if (!g) {
                    return 0
                }
                return Math.max(0, (g[1] ? g[1].length : 0) - (g[2] ? +g[2] : 0))
            },
            _applyToFixedAndParseFloat: function (h, g) {
                var i = h.toFixed(g);
                return parseFloat(i)
            },
            _getPercentage: function (h) {
                if (this.touchCapable && (h.type === "touchstart" || h.type === "touchmove")) {
                    h = h.touches[0]
                }
                var g = (h[this.mousePos] - this.offset[this.stylePos]) * 100 / this.size;
                g = Math.round(g / this.percentage[2]) * this.percentage[2];
                return Math.max(0, Math.min(100, g))
            },
            _validateInputValue: function (g) {
                if (typeof g === "number") {
                    return g
                } else {
                    if (g instanceof Array) {
                        this._validateArray(g);
                        return g
                    } else {
                        throw new Error(f.formatInvalidInputErrorMsg(g))
                    }
                }
            },
            _validateArray: function (j) {
                for (var h = 0; h < j.length; h++) {
                    var g = j[h];
                    if (typeof g !== "number") {
                        throw new Error(f.formatInvalidInputErrorMsg(g))
            ...
            _setDataVal: function (h) {
                var g = "value: '" + h + "'";
                this.element.setAttribute("data", g);
                this.element.setAttribute("value", h)
            },
            _trigger: function (g, l) {
                l = (l || l === 0) ? l : undefined;
                var k = this.eventToCallbackMap[g];
                if (k && k.length) {
                ...
                if (e) {
                    this._triggerJQueryEvent(g, l)
                }
            },
            _triggerJQueryEvent: function (g, i) {
                var h = {type: g, value: i};
                this.$element.trigger(h);
                this.$sliderElem.trigger(h)
            },
            ...
            _setText: function (g, h) {
                if (typeof g.innerText !== "undefined") {
                    g.innerText = h
                } else {
                    if (typeof g.textContent !== "undefined") {
                        g.textContent = h
                    }
                }
            },
            _removeClass: function (j, l) {
                var h = l.split(" ");
                var n = j.className;
                for (var g = 0; g < h.length; g++) {
                    var m = h[g];
                    var k = new RegExp("(?:\\s|^)" + m + "(?:\\s|$)");
                    n = n.replace(k, " ")
                }
                j.className = n.trim()
            },
            _addClass: function (j, l) {
                var h = l.split(" ");
                var o = j.className;
                for (var g = 0; g < h.length; g++) {
                    var n = h[g];
                    var k = new RegExp("(?:\\s|^)" + n + "(?:\\s|$)");
                    var m = k.test(o);
                    if (!m) {
                        o += " " + n
                    }
            ...
            _css: function (j, g, i) {
                if (e) {
                    ...
                    var h = g.replace(/^-ms-/, "ms-").replace(/-([\da-z])/gi, function (k, l) {
        ...
        if (e) {
            var d = e.fn.slider ? "bootstrapSlider" : "slider";
            e.bridget(d, a)
        }
    })(b);
    return a
...
!function (a) {
    a.fn["bootstrapSwitch"] = function (c) {
        var b = {
            init: function () {
                return this.each(function () {
                    var p = a(this), m, f, l, o, h = "", g = p.attr("class"), i, d, j = "ON", e = "OFF", n = false;
                    a.each(["size-MINI", "size-S", "size-L"], function (q, r) {
                        if (g.indexOf(r) >= 0) {
                            h = r
                        }
                    });
                    p.addClass("has-switch");
                    if (p.data("on") !== undefined) {
                        i = "switch-" + p.data("on")
                    }
                    if (p.data("on-label") !== undefined) {
                        j = p.data("on-label")
                    }
                    if (p.data("off-label") !== undefined) {
                        e = p.data("off-label")
                    }
                    if (p.data("icon") !== undefined) {
                        n = p.data("icon")
                    }
                    f = a("<span>").addClass("switch-left").addClass(h).addClass(i).html(j);
                    i = "";
                    if (p.data("off") !== undefined) {
                        i = "switch-" + p.data("off")
                    }
                    l = a("<span>").addClass("switch-right").addClass(h).addClass(i).html(e);
                    o = a("<label>").html("&nbsp;").addClass(h).attr("for", p.find("input").attr("id"));
                    if (n) {
                        o.html('<i class="icon icon-' + n + '"></i>')
                    }
                    m = p.find(":checkbox").wrap(a("<div>")).parent().data("animated", false);
                    if (p.data("animated") !== false) {
                        m.addClass("switch-animate").data("animated", true)
                    }
                    m.append(f).append(o).append(l);
                    p.find(">div").addClass(p.find("input").is(":checked") ? "switch-on" : "switch-off");
                    if (p.find("input").is(":disabled")) {
                        a(this).addClass("deactivate")
                    }
                    var k = function (q) {
                        q.siblings("label").trigger("mousedown").trigger("mouseup").trigger("click")
                    };
                    p.on("keydown", function (q) {
                        if (q.keyCode === 32) {
                            q.stopImmediatePropagation();
                            q.preventDefault();
                            k(a(q.target).find("span:first"))
                        }
                    });
                    f.on("click", function (q) {
                        k(a(this))
                    });
                    l.on("click", function (q) {
                        k(a(this))
                    });
                    p.find("input").on("change", function (u) {
                        var t = a(this), r = t.parent(), q = t.is(":checked"), s = r.is(".switch-off");
                        u.preventDefault();
                        r.css("left", "");
                        if (s === q) {
                            if (q) {
                                r.removeClass("switch-off").addClass("switch-on")
                            } else {
                                r.removeClass("switch-on").addClass("switch-off")
                            }
                            if (r.data("animated") !== false) {
                                r.addClass("switch-animate")
                            }
                            r.parent().trigger("switch-change", {"el": t, "value": q})
                        }
                    });
                    p.find("label").on("mousedown touchstart", function (r) {
                        var q = a(this);
                        d = false;
                        r.preventDefault();
                        r.stopImmediatePropagation();
                        q.closest("div").removeClass("switch-animate");
                        if (q.closest(".has-switch").is(".deactivate")) {
                            q.unbind("click")
                        } else {
                            q.on("mousemove touchmove", function (x) {
                                var s = a(this).closest(".switch"),
                                    u = (x.pageX || x.originalEvent.targetTouches[0].pageX) - s.offset().left,
                                    v = (u / s.width()) * 100, w = 25, t = 75;
                                d = true;
                                if (v < w) {
                                    v = w
                                } else {
                                ...
                                s.find(">div").css("left", (v - t) + "%")
                            });
                            q.on("click touchend", function (u) {
                                var t = a(this), s = a(u.target), v = s.siblings("input");
                                u.stopImmediatePropagation();
                                u.preventDefault();
                                t.unbind("mouseleave");
                                if (d) {
                                    v.prop("checked", !(parseInt(t.parent().css("left")) < -25))
                                } else {
                            ...
                            q.on("mouseleave", function (t) {
                                var s = a(this), u = s.siblings("input");
                                t.preventDefault();
                                t.stopImmediatePropagation();
                                s.unbind("mouseleave");
                                s.trigger("mouseup");
                                u.prop("checked", !(parseInt(s.parent().css("left")) < -25)).trigger("change")
                            });
                            q.on("mouseup", function (s) {
                ...
                if (d) {
                    a(this).removeClass("deactivate")
                } else {
                    a(this).addClass("deactivate")
                }
            }, toggleState: function (d) {
                var e = a(this).find("input:checkbox");
                e.prop("checked", !e.is(":checked")).trigger("change", d)
            }, setState: function (e, d) {
                a(this).find("input:checkbox").prop("checked", e).trigger("change", d)
            }, status: function () {
                return a(this).find("input:checkbox").is(":checked")
            }, destroy: function () {
                var d = a(this).find("div"), e;
                d.find(":not(input:checkbox)").remove();
                e = d.children();
                e.unwrap().unwrap();
                e.unbind("change");
                return e
